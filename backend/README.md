...
## Project Structure
    ...
    ├── testapiautocatalog_111481  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_111481`
...
2. Clone this repo and `cd testapiautocatalog_111481`
